...
public class RecentImages extends Fragment {

    GridView imagegrid;
    public static ArrayList<StatusModel> f = new ArrayList<>();
    public static RecWappAdapter myAdapter;
    ...
    public void populateGrid() {
        ...
        myAdapter = new RecWappAdapter(this, f, new RecWappAdapter.OnItemClickListener() {
            @Override
