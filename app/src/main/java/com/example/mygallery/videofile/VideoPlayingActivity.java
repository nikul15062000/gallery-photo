...
public class VideoPlayingActivity extends Activity implements ISwipeRefresh {
    public int postion;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
            ...
            currentpostion = getIntent().getExtras().getInt("songpostion");
        ...
        this.videoView.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                VideoPlayingActivity.this.mGestureDetector.onTouchEvent(event);
                VideoPlayingActivity.this.mScaleGestureDetector.onTouchEvent(event);
                return true;
            }
        });
        ...
        btnplayerbrithness.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!settingsCanWrite) {
                    startActivity(new Intent(android.provider.Settings.ACTION_MANAGE_WRITE_SETTINGS, Uri.parse("package:" + BuildConfig.APPLICATION_ID)));
                }
                dialog_brightness = new Dialog(VideoPlayingActivity.this);
        ...
        btnzoominout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog_zoominout = new Dialog(VideoPlayingActivity.this);
        ...
        audiotrack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dialog = new Dialog(VideoPlayingActivity.this);
        ...
        propeties.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog_filelist = new Dialog(VideoPlayingActivity.this);
...
//        final com.google.android.gms.ads.InterstitialAd interstitialAd = new com.google.android.gms.ads.InterstitialAd(Last_VideoView.this);
//
//
            ...
            public boolean onScroll(MotionEvent e1, MotionEvent e2, float velocityX, float velocityY) {
                ...
                try {
                    ...
                    if (Math.abs(diffX) > Math.abs(diffY)) {
                        ...
                        if (((double) e1.getX()) < ((double) VideoPlayingActivity.getDeviceWidth(VideoPlayingActivity.this)) * 0.5d) {
                            VideoPlayingActivity.this.onVerticalScroll(deltaY / ((float) VideoPlayingActivity.getDeviceHeight(VideoPlayingActivity.this)), 1);
                        } else if (((double) e1.getX()) > ((double) VideoPlayingActivity.getDeviceWidth(VideoPlayingActivity.this)) * 0.5d) {
                            VideoPlayingActivity.this.onVerticalScroll(deltaY / ((float) VideoPlayingActivity.getDeviceHeight(VideoPlayingActivity.this)), 2);
                        }
                    } else {
...
//            int name = videocursor
//                    .getColumnIndex(MediaStore.Audio.Media.DATA);
//          videocursor.moveToPosition(currentpostion - 1);
//            String filename = videocursor.getString(name);

            String[] columns = VideoPlayingActivity.this.videocursor.getColumnNames();
            int name = VideoPlayingActivity.this.videocursor.getColumnIndex("_data");
            VideoPlayingActivity.this.videocursor.moveToPosition(VideoPlayingActivity.this.currentpostion - 1);
            String filename = VideoPlayingActivity.this.videocursor.getString(name);
...
//            int name = videocursor
//                    .getColumnIndex(MediaStore.Audio.Media.DATA);
//            videocursor.moveToPosition(videosongcount - 1);
//            String filename = videocursor.getString(name);
            String[] columns = VideoPlayingActivity.this.videocursor.getColumnNames();
            int name = VideoPlayingActivity.this.videocursor.getColumnIndex("_data");
            VideoPlayingActivity.this.videocursor.moveToPosition(VideoPlayingActivity.this.videosongcount - 1);
            String filename = VideoPlayingActivity.this.videocursor.getString(name);
...
//    if (VideoPlayingActivity.this.current + 1 == VideoListActivity.videoList.size()) {
//        VideoPlayingActivity.this.current = 0;
//    } else {
//        VideoPlayingActivity videoViewActivity = VideoPlayingActivity.this;
//        videoViewActivity.current++;
//    }
//    VideoViewActivity.this.loadVideo();
//}
    public void btnnext() {
        if (currentpostion < videosongcount - 1) {
            String[] columns = videocursor.getColumnNames();
            int name = videocursor
                    .getColumnIndex(MediaStore.Audio.Media.DATA);
            videocursor.moveToPosition(currentpostion + 1);
...
//            super.onPostExecute(s);
    ...
    private class MyScaleGestureListener implements ScaleGestureDetector.OnScaleGestureListener {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            if (!VideoPlayingActivity.this.screenbLockFlag) {
                this.mW = (int) (((float) this.mW) * detector.getScaleFactor());
                this.mH = (int) (((float) this.mH) * detector.getScaleFactor());
                if (this.mW < 100) {
                    this.mW = VideoPlayingActivity.this.videoView.getWidth();
                    this.mH = VideoPlayingActivity.this.videoView.getHeight();
                }
                Log.d("onScale", "scale=" + detector.getScaleFactor() + ", w=" + this.mW + ", h=" + this.mH);
                VideoPlayingActivity.this.videoView.setFixedVideoSize(this.mW, this.mH);
//                VideoPlayingActivity.this.mRootParam.width = this.mW;
//                VideoPlayingActivity.this.mRootParam.height = this.mH;
            }
            return true;
        }
    ...
    private class MySimpleOnGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            VideoPlayingActivity.this.mCurVolume = -1;
            VideoPlayingActivity.this.mCurBrightness = -1.0f;
            VideoPlayingActivity.this.seekVolume.setVisibility(View.GONE);
            VideoPlayingActivity.this.txtScalView.setVisibility(View.GONE);
            VideoPlayingActivity.this.seekbrightness.setVisibility(View.GONE);
            VideoPlayingActivity.this.txtbrighness.setVisibility(View.GONE);
            //   VideoPlayingActivity.this.textScreenSize.setVisibility(8);
            if (Show_Data.slideshow == 0) {
                VideoPlayingActivity.this.bottumlaout.startAnimation(AnimationUtils.loadAnimation(VideoPlayingActivity.this.getApplicationContext(), R.anim.translate_animation));
                if (VideoPlayingActivity.this.bottumlaout.getVisibility() == View.VISIBLE) {
                    VideoPlayingActivity.this.bottumlaout.setVisibility(View.GONE);
                    img_rotate.setVisibility(View.GONE);
                } else {
                    VideoPlayingActivity.this.bottumlaout.setVisibility(View.VISIBLE);
                    img_rotate.setVisibility(View.VISIBLE);
                }
                VideoPlayingActivity.this.linearlayouttop.startAnimation(AnimationUtils.loadAnimation(VideoPlayingActivity.this.getApplicationContext(), R.anim.top_slide_animation));
                if (VideoPlayingActivity.this.linearlayouttop.getVisibility() == View.VISIBLE) {
                    VideoPlayingActivity.this.linearlayouttop.setVisibility(View.GONE);
                    img_rotate.setVisibility(View.GONE);
                    //VideoPlayingActivity.this.imgRotate.setVisibility(8);
                } else {
                    VideoPlayingActivity.this.linearlayouttop.setVisibility(View.VISIBLE);
                    img_rotate.setVisibility(View.VISIBLE);
                    //VideoPlayingActivity.this.imgRotate.setVisibility(0);
                }
                Show_Data.slideshow = 1;
            } else {
                VideoPlayingActivity.this.bottumlaout.startAnimation(AnimationUtils.loadAnimation(VideoPlayingActivity.this.getApplicationContext(), R.anim.side_di_animation));
                if (VideoPlayingActivity.this.bottumlaout.getVisibility() == View.VISIBLE) {
                    VideoPlayingActivity.this.bottumlaout.setVisibility(View.GONE);
                    img_rotate.setVisibility(View.GONE);
                } else {
                ...
                VideoPlayingActivity.this.linearlayouttop.startAnimation(AnimationUtils.loadAnimation(VideoPlayingActivity.this.getApplicationContext(), R.anim.top_slide_up_animation));
                if (VideoPlayingActivity.this.linearlayouttop.getVisibility() == View.VISIBLE) {
                    VideoPlayingActivity.this.linearlayouttop.setVisibility(View.GONE);
                    img_rotate.setVisibility(View.GONE);
                    // VideoPlayingActivity.this.imgRotate.setVisibility(8);
...
//            imgPress.setVisibility(View.VISIBLE);
                volume_level = audio.getStreamVolume(AudioManager.STREAM_MUSIC);
                if (volume_level > 0 && volume_level < audio.getStreamMaxVolume(AudioManager.STREAM_MUSIC) / 3) {
//                imgPress.setBackgroundResource(R.drawable.three);
                } else if (volume_level > audio.getStreamMaxVolume(AudioManager.STREAM_MUSIC) / 3
                        && volume_level < audio.getStreamMaxVolume(AudioManager.STREAM_MUSIC) - 2) {
//                imgPress.setBackgroundResource(R.drawable.two);
                } else if (volume_level == 0) {
//                imgPress.setBackgroundResource(R.drawable.three);
                } else if (volume_level >= audio.getStreamMaxVolume(AudioManager.STREAM_MUSIC) - 2) {
//                imgPress.setBackgroundResource(R.drawable.one);
                }
                txtScalView.setVisibility(View.VISIBLE);
...
//            imgPress.setBackgroundResource(R.drawable.trans);
                txtScalView.setVisibility(View.GONE);
                seekVolume.setVisibility(View.GONE);
