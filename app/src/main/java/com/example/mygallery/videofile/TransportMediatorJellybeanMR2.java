...
class TransportMediatorJellybeanMR2 {
    ...
    void windowAttached() {
        ...
        this.mPendingIntent = PendingIntent.getBroadcast(this.mContext, 0, this.mIntent, Intent.FILL_IN_ACTION);
    ...
    public void refreshState(boolean playing, long position, int transportControls) {
        if (this.mRemoteControl != null) {
            this.mRemoteControl.setPlaybackState(playing ? 3 : 1, position, playing ? 1f : 0.0f);
