...
public class GestureDetection2 extends GestureDetector.SimpleOnGestureListener {
    ...
    public final static int MODE_SOLID = 5;
    public final static int MODE_DYNAMIC = 6;
    ...
    public GestureDetection2(Activity context, SimpleGestureListener sgl) {
